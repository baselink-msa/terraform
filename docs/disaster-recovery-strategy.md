...
| daily-rds-copy | Terraform 구현·배포 대기 | RDS recovery point | daily | 14일 | 도쿄 리전 장애 복구 |
...
1. 도쿄 리전 backup vault와 daily copy action 배포
2. 첫 copy job과 도쿄 recovery point 확인
...
- 도쿄 backup vault와 RDS cross-region copy — Terraform 구현·배포 대기
